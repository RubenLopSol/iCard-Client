  ...
  return (
    <div className='select-table'>
      ...
      <div className='select-table__content'>
        ...
        <h2>Introcuce tu numero de mesa</h2>

        <Form onSubmit={onSubmit}>
          <Form.Input placeholder="Ejemplo 135, 873,904,337" type="number" onChange={(_, data) => setTableNum (data.value)} />
